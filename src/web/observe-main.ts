...
document.querySelector('#app')!.innerHTML = `
  <header class="site-header"><a class="brand" href="./" aria-label="Line follower sim home"><span class="brand-mark" aria-hidden="true">↱</span> LINE FOLLOWER <span class="brand-light">/ SIM</span></a><nav class="studio-nav" aria-label="Simulator pages"><a href="./chassis.html">Chassis</a><a href="./board.html">Boards</a><a href="./observe.html" aria-current="page">Sensors</a><a href="./simulate.html">Run</a><a href="./sweep.html">Sweeps</a><a href="./pid-tuning.html">PID tuning</a><a href="./robustness.html">Robustness</a></nav></header>
