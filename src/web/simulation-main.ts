...
<section class="board-note"><span class="tiny-tag">SWEEP READY</span><p>Each trial is a complete condition row plus one aggregate summary. The same core can expand parameter grids in a Web Worker or Node runner without rendering.</p></section><footer><span>Exact differential-drive integration with bounded collision substeps.</span><span>Stage 5 · Closed loop</span></footer></main>`;
